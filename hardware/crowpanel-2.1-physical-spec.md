...
| **USB-C port** | on the **BACK** face (power + flashing) | ✅ |
...
5. USB-C exits the **back** — leave a center/rear opening for the cable (no side
   cutout needed).
...
- Validated with `wall-mount/templates.pdf` (1:1 paper templates) against the
  physical unit — screw pattern ✅, Ø58 body ✅, Ø79 bezel ✅, USB-C-on-back ✅.
