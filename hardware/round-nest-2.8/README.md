...
- **`crowpanel-2.1-physical-spec.md`** — reverse-engineered mechanical spec (Ø79
  rotating bezel, Ø58 rear body, 3×M3 Ø12-BC rear holes, USB-C on the back). Read this
  before designing any part for this unit. **Hard rule: mount from the rear only — the
  front bezel rotates, never clamp it.**
