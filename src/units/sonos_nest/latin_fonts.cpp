...
lv_font_t nestFont20, nestFont24, nestFont28;
...
struct Wire {
  Wire() {
    nestFont20 = withFallback(lv_font_montserrat_20, &lv_font_mont_latin_20);
    nestFont24 = withFallback(lv_font_montserrat_24, &lv_font_mont_latin_24);
    nestFont28 = withFallback(lv_font_montserrat_28, &lv_font_mont_latin_28);
  }
};
const Wire s_wire;
